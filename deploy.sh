...
wget https://raw.githubusercontent.com/robustfengbin/one_click_deploy_qwen_1.5_14b_q4/main/requirements.txt
pip install -r requirements.txt
wget https://raw.githubusercontent.com/robustfengbin/one_click_deploy_qwen_1.5_14b_q4/main/main.py
